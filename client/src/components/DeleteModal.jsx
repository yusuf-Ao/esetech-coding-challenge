...
import { removeNote } from '../state/actions/note.actions';
...
const DeleteModal = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(removeNote({ noteId: currentNote?.id, toast, modals, setModals }));
  };
  return (
    <div>
      <div
        ...
        <div className='relative p-4 w-full max-w-md max-h-full'>
          <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
            ...
            <div className='p-4 md:p-5 text-center'>
              ...
              <h3 className='mb-2 text-lg font-normal text-green-500'>
                {currentNote?.title}
              </h3>
